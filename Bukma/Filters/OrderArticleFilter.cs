...
{
    public class OrderArticleFilter : IFilter<V_OrderArticle>, INotifyPropertyChanged
    { 
        public OrderArticleFilter(string nameFiltred = null)
        {
        ...
        public List<V_OrderArticle> GetFiltredList(List<V_OrderArticle> values)
        {
